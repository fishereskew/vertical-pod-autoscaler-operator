...
var _ = Describe("Testing Status", func() {
	...
	Describe("Check VPA Recommender", func() {
		...
		for _, tc := range testCases {
			It(fmt.Sprintf("should have correct values %s", tc.label), func() {
	...
	Describe("Testing Status Changes", func() {
		...
		for _, tc := range testCases {
			It(fmt.Sprintf("should have correct status for case %s", tc.label), func() {
				reporter := &StatusReporter{
	...
	Describe("Test Report Status", func() {
		...
		for _, tc := range testCases {
			It(fmt.Sprintf("should report the status correctly for case %s", tc.label), func() {
				reporter := &StatusReporter{
